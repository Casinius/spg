...
{
template<class T>
auto l_springConstraint(const SpringContinuumEnergy *energy, const int i, const ParticleGroup &pGroup, T &dC) {
...
void SpringContinuumEnergy::dConstraints(const int i, const ParticleGroup &pGroup, ConstraintsAD1 &dC) const
{
    l_springConstraint(this, i, pGroup, dC);
}

void SpringContinuumEnergy::dConstraints(const int i, const ParticleGroup &pGroup, ConstraintsAD2 &dC) const
{
    l_springConstraint(this, i, pGroup, dC);
}
}  // namespace spg